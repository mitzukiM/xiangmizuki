...
item_1_quantity = decimal.Decimal(item_1_quantity).quantize(Decimal('0.01'))
# goods 2 section
item_2_title = textwrap.shorten(input('Введіть назву другого товару: ').ljust(20, '.'), width=20,
                                placeholder='...')
item_2_quantity = input('Введіть бажаєму кількість другого товару: ')
item_2_price = input('Введіть ціну другого товару: ')
item_2_quantity = decimal.Decimal(item_2_quantity).quantize(Decimal('0.01'))
...
item_1_price = decimal.Decimal(item_1_price).quantize(Decimal('0.01'))
...
item_2_price = decimal.Decimal(item_2_price).quantize(Decimal('0.01'))
